  ...
  return (
    <div className=" ">
      <div
        ...
        style={{
          backgroundImage: "url('./src/Picture/1oop.png')",
          // opacity: 0.8,
        }}
      >
      ...
      <section className="h-dvh ">
        <aside className="h-[40%] flex flex-col justify-center items-center gap-5 ">
          ...
          <img
            src="./src/Picture/icon_heading.png"
      ...
      <section className="h-dvh ">
        ...
        <div className="h-[60%] w-full ">
          <div className="h-full w-[50%]  px-30 ">
            <img
              className="h-full"
              src="./src/Picture/undraw_makeup-artist_0xtr.svg"
            />
          </div>
          <div></div>
        </div>
      ...
      <footer className="h-[70vh] bg-[#FF8FAB]">
        <div className="h-[40%]  flex flex-row">
          ...
          <div className="w-50 h-40  overflow-hidden  rounded-xl ">
            <img
              src="./src/Picture/land-slider-img-3.png"
